        ...
        {/* <div className="overflow-hidden rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
          ...
          <div className="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
            ...
            <div className="mt-4">
              ...
              <p className="font-medium">Sr. UI Engineer</p>
              ...
              <div className="mx-auto max-w-180">
                ...
                <p className="mt-4.5">
                  Mason Aviles is a skilled Front-End and Full Stack Engineer with over nine years of experience, specializing in JavaScript, TypeScript, and Python across frameworks like React and Django. Renowned for creating intuitive interfaces and leading impactful projects, Mason&apos;s passion for technology and continuous learning drives his success in enhancing user experiences and fostering innovation.
                </p>
              </div>
